-module(shurbey_session_cleaner).
...
-define(SESSION_TTL_MS, 600000).  %% 10 minutes (must match shurbey_session)
...
cleanup_sessions() ->
    shurbey_session:cleanup_expired().

cleanup_uploads() ->
    shurbey_files:cleanup_expired_uploads().
